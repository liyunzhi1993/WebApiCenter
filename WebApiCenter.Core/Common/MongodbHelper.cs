...
namespace WebApiCenter.Core.Common
{
    ...
    {
        public static readonly string connectionString_Default = System.Configuration.ConfigurationManager.ConnectionStrings["ClinetConnection"].ToString();
        public static readonly string database_Default = System.Configuration.ConfigurationManager.AppSettings["ClientDataBase"];
